...
TAG=ar_qweb600m_v1
RUN_NAME=wmt--bs${BATCH_SIZE}-keep${KEEP_EVERY_N_LAYERS}-max${MAX_DURATION}-lr${LR}-warmup${WARMUP_DURATION}-gc${GRAD_CLIP}-wd${WEIGHT_DECAY}-${TAG}
