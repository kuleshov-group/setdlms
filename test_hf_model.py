"""Run a single inference with the quantized LLaDA model.

This script loads the Transformers LLaDA model using the project's loader,
which knows how to load AQLM-quantized weights. It then runs one generation
for a sample prompt and prints output.
...
- By default this uses the local quantized folder `./quant-llada-8b-aqlm`
  in the repo root.
"""
