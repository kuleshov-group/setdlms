...
class AR(Denoiser):
    ...
    def _prepare_inputs_inference(
        ...
        **backbone_kwargs: Any,
        ...
        position_ids = torch.arange(cache_length, full_seq_length).to(input_ids.device)[None, :]
        return DenoiserInput(
            xt=input_ids,
            x0=context,
            attention_mask=attention_mask,
    ...
    def _nucleus_sample(self, p_x0: torch.FloatTensor, p: float):
        ...
        p_x0[:, -self.config.block_size:] = p_x0
        return p_x0
    ...
    def generate(
        ...
        **kwargs,
        ...
        if input_len == 0:
            ...
            # cache
            cache_inputs = self._prepare_inputs_inference(inputs, None, None, None, cache)
