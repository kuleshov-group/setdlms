...
class LMEvalHarnessModelRecordIntm(LM):
    def __init__(
        self,
    ...
    def generate_until(self, requests, **generation_kwargs):
        ...
        for i, elem in tqdm(
            ...
            sample, intm_samples, caching_wall_clocks, decoding_wall_clocks = self.model.generate(
        ...
        with open(f"{samples_path}_intermediate_samples.json", "w") as f:
            json.dump(
                all_intm_samples,
                f,  # type: ignore
                indent=2,
