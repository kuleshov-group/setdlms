...
EVAL_MODELS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("owt", "AR", td_dir("mari-owt-ar-noeos-v4-1"), "20-300000.ckpt", True, "e2d2-owt-ar"),
    ModelSpec("owt", "MDLM", td_dir("mari-owt-mdlm-noeos-v4"), "18-300000.ckpt", True, "e2d2-owt-mdlm"),
    ModelSpec("owt", "BD3LM-s4", run_dir("owt_block4_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_normlayernorm_adalnfalse_vscratch2"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-bd3lm-s4"),
    ModelSpec("owt", "BD3LM-s8", run_dir("owt_block8_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_normlayernorm_adalnfalse_vscratch2"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-bd3lm-s8"),
    ModelSpec("owt", "BD3LM-s16", run_dir("owt_block16_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_normlayernorm_adalnfalse_vscratch2"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-bd3lm-s16"),
    ModelSpec("owt", "SetDLM-d4", run_dir("owt_block1024_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_normlayernorm_adalnfalse_block4_vscratch"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-setdlm-d4"),
    ModelSpec("owt", "SetDLM-d8", run_dir("owt_block1024_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_normlayernorm_adalnfalse_block8_vscratch"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-setdlm-d8"),
    ModelSpec("owt", "SetDLM-d16", run_dir("owt_block1024_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_normlayernorm_adalnfalse_block16_vscratch"), "ep17-ba300000-rank0.pt", False, "e2d2-owt-setdlm-d16"),
    # LM1B likelihood / throughput targets.
    ModelSpec("lm1b", "AR", run_dir("lm1b_block128_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter_ar_hparam_v1"), "best-rank0.pt", True, "e2d2-lm1b-ar"),
    ModelSpec("lm1b", "MDLM", run_dir("lm1b_block128_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_mdlm_adaln_cleanbos_antithetic_hparam_v2"), "ep72-ba1000000-rank0.pt", False, "e2d2-lm1b-mdlm"),
    ModelSpec("lm1b", "BD3LM-s4", run_dir("lm1b_block4_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_dropout0.1_normlayernorm_hparam_v3"), "ep72-ba1000000-rank0.pt", False, "e2d2-lm1b-bd3lm-s4"),
    ModelSpec("lm1b", "BD3LM-s8", run_dir("lm1b_block8_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_dropout0.1_normlayernorm_hparam_v3"), "best-rank0.pt", True, "e2d2-lm1b-bd3lm-s8"),
    ModelSpec("lm1b", "BD3LM-s16", run_dir("lm1b_block16_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_bd3lm_dropout0.1_normlayernorm_hparam_v3"), "ep72-ba1000000-rank0.pt", False, "e2d2-lm1b-bd3lm-s16"),
    ModelSpec("lm1b", "SetDLM-d4", run_dir("lm1b_block128_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_dropout0.1_normlayernorm_hparam_desired4_max128_v5"), "ep72-ba1000000-rank0.pt", False, "e2d2-lm1b-setdlm-d4"),
    ModelSpec("lm1b", "SetDLM-d8", run_dir("lm1b_block128_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_dropout0.1_normlayernorm_hparam_desired8_max128_v5"), "ep72-ba1000000-rank0.pt", False, "e2d2-lm1b-setdlm-d8"),
    ModelSpec("lm1b", "SetDLM-d16", run_dir("lm1b_block128_lr3e-4_bsz512_warm2500ba_layers12_hidden768_inter3072_aoarm_dropout0.1_normlayernorm_hparam_desired16_vlambda"), "best-rank0.pt", True, "e2d2-lm1b-setdlm-d16"),
    # CNN/DM summarization targets.
    ModelSpec("cnndm", "AR", run_dir("cnn_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_ar_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-ar"),
    ModelSpec("cnndm", "MDLM", run_dir("cnn_block_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_mdlm_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-mdlm"),
    ModelSpec("cnndm", "BD3LM-s4", run_dir("cnn_block4_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_bd3lm_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-bd3lm-s4"),
    ModelSpec("cnndm", "BD3LM-s8", run_dir("cnn_block8_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_bd3lm_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-bd3lm-s8"),
    ModelSpec("cnndm", "BD3LM-s16", run_dir("cnn_block16_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_bd3lm_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-bd3lm-s16"),
    ModelSpec("cnndm", "SetDLM-d4", run_dir("cnn_block768_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_aoarm_tgt4_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-setdlm-d4"),
    ModelSpec("cnndm", "SetDLM-d8", run_dir("cnn_block768_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_aoarm_tgt8_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-setdlm-d8"),
    ModelSpec("cnndm", "SetDLM-d16", run_dir("cnn_block768_lr3e-4_bsz128_warm1000ba_layers28_hidden256_inter768_aoarm_tgt16_len768_v1"), "best-rank0.pt", True, "e2d2-cnndm-setdlm-d16"),
    # GSM8K accuracy / likelihood / throughput targets.
    ModelSpec("gsm8k", "AR", run_dir("gsm8k-0shot_lr1e-5_bsz1_warm100ba_alphaf0.5_max-dur75000ba_amp_bf16_layers28_ar_distill_v6"), "best-rank0.pt", True, "e2d2-gsm8k-ar"),
    ModelSpec("gsm8k", "MDLM", run_dir("gsm8k-0shot_block_lr1e-5_bsz1_warm100ba_alphaf0.5_max-dur75000ba_amp_bf16_layers28_mdlm_distill_v6"), "best-rank0.pt", True, "e2d2-gsm8k-mdlm"),
    ModelSpec("gsm8k", "BD3LM-s4", run_dir("gsm8k-shot_block4_lr1e-5_bsz1_warm100ba_max-dur75000ba_amp_bf16_layers28_bd3lm_distill_anneal0ba_maxbs4_v10"), "best-rank0.pt", True, "e2d2-gsm8k-bd3lm-s4"),
    ModelSpec("gsm8k", "BD3LM-s8", run_dir("gsm8k-shot_block8_lr1e-5_bsz1_warm100ba_max-dur75000ba_amp_bf16_layers28_bd3lm_distill_anneal0ba_maxbs8_v10"), "best-rank0.pt", True, "e2d2-gsm8k-bd3lm-s8"),
    ModelSpec("gsm8k", "BD3LM-s16", run_dir("gsm8k-shot_block16_lr1e-5_bsz1_warm100ba_max-dur75000ba_amp_bf16_layers28_bd3lm_distill_anneal0ba_maxbs16_v10"), "best-rank0.pt", True, "e2d2-gsm8k-bd3lm-s16"),
